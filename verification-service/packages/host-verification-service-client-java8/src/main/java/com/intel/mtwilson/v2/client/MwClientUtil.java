...
public class MwClientUtil {
     ...
     * </pre>
     */        
    public static SimpleKeystore createUserInDirectoryV2(File directory, String username, String password, URL server, String comments, Properties properties) throws IOException, CryptographyException {
     ...
     *  String password = "password";
     *  URL server = new URL("https://192.168.0.1:8181/mtwilson/v2/");
     *  String fileName = String.format(""c:\\intel\\mtwilson\\%s.jks"",userName);
     *  FileResource resource = new FileResource(new java.io.File(fileName));
     *                  
    ...
    public static SimpleKeystore createUserInResourceV2(Resource resource, String username, String password, 
            URL server, Properties properties, String comments, Locale locale, String tlsProtocol) throws IOException, CryptographyException {
