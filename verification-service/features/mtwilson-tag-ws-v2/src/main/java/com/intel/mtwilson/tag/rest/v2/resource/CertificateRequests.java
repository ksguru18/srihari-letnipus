...
public class CertificateRequests extends AbstractJsonapiResource<CertificateRequest, CertificateRequestCollection, CertificateRequestFilterCriteria, NoLinks<CertificateRequest>, CertificateRequestLocator> {
    ...
    public void deleteOne(@BeanParam CertificateRequestLocator locator, @Context HttpServletRequest httpServletRequest, @Context HttpServletResponse httpServletResponse) {
        CertificateRequest item = getRepository().retrieve(locator);
        if (item == null) {
