...
public class CreateDatabase {
    ...
    public void createTables() throws SQLException {
        ...
        // certificate
        TagCertificateDAO tagCertificateDAO = dbi.open(TagCertificateDAO.class);
        if( !Derby.tableExists("mw_tag_certificate") ) { tagCertificateDAO.create(); }
        tagCertificateDAO.close();
